...
export const FormWrapper = WithNotification(
  ({ api, apiById, schema, formSchema, notify, normalizer, apiNormalizer }) => {
    const { id } = useParams();
    ...
    const fetchData = useCallback(async () => {
      ...
      try {
        ...
        if (data) {
          const normalized = normalizer?.(data) || data;
